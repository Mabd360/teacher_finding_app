              ...
              : _errorMessage != null
                  ...
                  : _requests.isEmpty
                      ? const EmptyStateWidget(
                          ...
                          description: 'You have not sent any requests to teachers yet.',
                        )
                      : RefreshIndicator(
                                ...
                                child: ModernCard(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (request.subjects != null && request.subjects!.isNotEmpty) ...[
                                      ...
                                      if (request.status == 'accepted') ...[
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                              'Email: ${request.teacherEmail ?? "N/A"}',
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            const SizedBox(width: AppTheme.sm),
                                            Text(
                                              'Phone: ${request.teacherPhone ?? "N/A"}',
                                              style: const TextStyle(fontWeight: FontWeight.w500),
                                            ),
                                          ],
                                        ),
                                                  ...
                                                  Navigator.of(context).push(
                                                    MaterialPageRoute(
                                                      builder: (context) => ChatScreen(
                                                        otherUserId: request.teacherId ?? '',
                                                        otherUserName: request.teacherName ?? 'Teacher',
                                                      ),
                                                    ),
                                                  );
                                                },
